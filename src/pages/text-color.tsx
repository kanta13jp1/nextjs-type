...
const TextColor: NextPage = () => {
  return (
    <div className="container mx-auto px-6 py-8">
      <div className="flex min-h-screen flex-col justify-top py-0 px-2">
        <Head>
        ...
        <main>
          ...
          <div className="flex">
            <div className="flex-1">
              ...
              <br />
              <h1 className="flex-1 text-red-100 text-xl">text-red-100 text-xl</h1>
              <br />
              <h1 className="flex-1 text-red-200 text-xl">text-red-200 text-xl</h1>
              <br />
