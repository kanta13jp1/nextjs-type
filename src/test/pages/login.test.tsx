...
class Page {
  ...
  Eメール入力エリア(): Element {
    return this.container.querySelector('#email') as Element;
  }

  Eメールエラーメッセージエリア(): Element {
    return this.container.querySelector('.email-error-message-area') as Element;
  }

  パスワード入力エリア(): Element {
    return this.container.querySelector('#password') as Element;
  }

  パスワードエラーメッセージエリア(): Element {
    return this.container.querySelector('.password-error-message-area') as Element;
  }
  ...
  確認モーダルメッセージ(): Element {
    return this.container.querySelector('.modal-message') as Element;
  }

  確認モーダルキャンセルボタン(): Element {
    return this.container.querySelector('.modal-cancel') as Element;
  }

  確認モーダルサブミットボタン(): Element {
    return this.container.querySelector('.modal-submit') as Element;
  }

  ログインボタン(): Element {
    return this.container.querySelector('.primary-button') as Element;
  }
...
describe('Login page', () => {
  ...
  describe('入力バリデーション', () => {
    it('Eメール未入力で、ログインボタンをクリックしたとき、Eメールが必須エラーとなること', async () => {
      ...
      expect(page.Eメールエラーメッセージエリア().textContent).toEqual('入力してください');
    });
    ...
    it('パスワード未入力で、ログインボタンをクリックしたとき、パスワードが必須エラーとなること', async () => {
      ...
      expect(page.パスワードエラーメッセージエリア().textContent).toEqual('入力してください');
    });
