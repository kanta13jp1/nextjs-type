...
class Page {
  ...
  一ページ目リンク(): Element {
    return this.container.querySelector('.page-link-1') as Element;
  }

  二ページ目リンク(): Element {
    return this.container.querySelector('.page-link-2') as Element;
  }

  三ページ目リンク(): Element {
    return this.container.querySelector('.page-link-3') as Element;
  }

  四ページ目リンク(): Element {
    return this.container.querySelector('.page-link-4') as Element;
  }

  五ページ目リンク(): Element {
    return this.container.querySelector('.page-link-5') as Element;
  }

  六ページ目リンク(): Element {
    return this.container.querySelector('.page-link-6') as Element;
  }

  七ページ目リンク(): Element {
    return this.container.querySelector('.page-link-7') as Element;
  }

  八ページ目リンク(): Element {
    return this.container.querySelector('.page-link-8') as Element;
  }

  九ページ目リンク(): Element {
    return this.container.querySelector('.page-link-9') as Element;
  }

  十ページ目リンク(): Element {
    return this.container.querySelector('.page-link-10') as Element;
  }
...
describe('Pager components', () => {
  it('matches snapshot', () => {
    ...
    const { asFragment } = render(<Pager pageItem={item} search={handleClick} />, {});
  ...
  it('全10ページ かつ 現在1ページ目を指定しているとき、ページャの数が期待値どおりであること', () => {
    ...
    const { container } = render(<Pager pageItem={item} search={handleClick} />, {});
